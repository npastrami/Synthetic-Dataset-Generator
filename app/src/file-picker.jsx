...
const ACCEPTED_MIME_TYPES = ['application/pdf', 'application/vnd.ms-excel', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'];
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.canvas_wrapper}>
        <DropZone onChange={handleOnChange} accept={ACCEPTED_MIME_TYPES} />
      </div>
